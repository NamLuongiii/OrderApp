...
func MapOrder(persistenceOrder table.Order) (model.Order, error) {
	lineItems := make([]model.LineItem, len(persistenceOrder.LineItems))
	...
	order := model.NewOrder(
		...
		model.Status(persistenceOrder.Status),
	)
